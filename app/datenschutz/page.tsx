...
export default function Datenschutz() {
  return (
    <div className="text-left w-full max-w-[1200px] px-8">
      <h2 className="text-3xl font-extrabold">Datenschutz</h2 >
      <br />
      <p>Zuletzt aktualisiert am: 26.07.2024</p>
      <br />
      <p>
      ...
      <br />
      <h3 className="text-xl font-bold">1. Welche Dienste wir nutzen</h3>
      <p>
      </p>
      <ul>
        <li>
      ...
      <br />
      <h3 className="text-xl font-bold">2. Kontaktinformationen</h3>
      <p>Bei Fragen oder Anliegen zum Schutz Ihrer Daten durch uns erreichen Sie uns jederzeit per E-Mail unter <Link href="mailto:info@lc-gebaeudetechnik.ch" className="text-sky-700 dark:text-sky-300 underline">info@lc-gebaeudetechnik.ch</Link>. Verantwortlich für die Datenbearbeitungen, die über diese Website erfolgen, ist:</p>
      <br />
      ...
      <h4 className="text-lg font-bold">3.1 Welche Daten sammeln wir von Ihnen und von wem erhalten wir diese Daten</h4>
      ...
      <ul>
        ...
        <li>Kontaktdaten (Telefonnummer, E-Mailadresse, etc.);</li>
        <li>Finanzdaten (bspw. Kontoangaben);</li>
        <li>Onlinekennungen (bspw. Cookie-Kennung, IP-Adressen);</li>
      </ul>
      <br />
      <h4 className="text-lg font-bold">3.2 Unter welchen Voraussetzungen bearbeiten wir Ihre Daten?</h4>
      ...
      <br />
      <h4 className="text-lg font-bold">3.3 Wie können Sie Ihre Einwilligung widerrufen?</h4>
      ...
      <br />
      <h4 className="text-lg font-bold">3.4 In welchen Fällen können wir Ihre Daten an Dritte weitergeben?</h4>
      <br />
      <h5 className="text-md font-bold">a. Grundsatz</h5>
      ...
      <br />
      <h5 className="text-md font-bold">b. Besuch unserer Social-Media-Kanäle</h5>
      ...
      <br />
      <h4 className="text-lg font-bold">3.6 Wie schützen wir Ihre Daten?</h4>
      ...
      <br />
      <h4 className="text-lg font-bold">3.7 Welche Rechte haben Sie?</h4>
      <br />
      <h5 className="text-md font-bold">a. Auskunftsrecht</h5>
      <p>Sie können jederzeit eine Auskunft über die von uns über Sie gespeicherten Daten verlangen. Wir bitten Sie, Ihr Auskunftsgesuch zusammen mit einem Identitätsnachweis an <Link href="mailto:info@lc-gebaeudetechnik.ch" className="text-sky-700 dark:text-sky-300 underline">info@lc-gebaeudetechnik.ch</Link> zu senden.<br /><br />Sie haben ausserdem das Recht, Ihre Daten in einem gängigen Dateiformat zu erhalten, wenn wir Ihre Daten automatisiert bearbeiten, und wenn:</p>
      <ul>
      ...
      <br />
      <h5 className="text-md font-bold">b. Löschung und Berichtigung</h5>
      <br />
      ...
      <br />
      <h5 className="text-md font-bold">c. Rechtsweg</h5>
      ...
      <br />
      <h5 className="text-md font-bold">Weshalb dürfen wir diese Daten bearbeiten?</h5>
      ...
      <br />
      <h5 className="text-md font-bold">Wie können Sie die Datenerfassung verhindern?</h5>
